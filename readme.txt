...
Tags: tumblr, tumblr blogs, tumblr blog display, widget, blog, tumblr widget, tumblr display, tumblr blog list, tumblr blog display plugin, tumblr plugin, tumblr for wordpress, tumblr shortcode plugin
...
Demo: http://ramit-designs.com/wpdemo/index.php/tumblr-blog-display/

Demo built with shortcode:
[tumblr_blog blog_url="barackobama.tumblr.com" api_key="CREATE YOUR API" limit="6" text_limit="40"]

Tumblr is a micro blogging platform. Tumblr is also a social networking platform. Using Tumblr Blog Display Shortcode you will able to display the list of latest tumblr blogs on your website. You can put the shortcode anywhere in your wordpress theme position.

Using Tumblr Blog Display Shortcode is quite easy but you must have to create Tumblr API on Tumblr Official Website.

Tumblr Blog Display Shortcode – So everyone your ideas and what you’ve posted on your tumblr blog site.

Tumblr Blog Display Shortcode is very useful for displaying latest blogs from tumblr in your website. And what I might haven’t mentioned yet – Tumblr Blogs will be link as well. Tumblr care about your privacy so do we. You will able to show your tumblr blog post on your website only. No mercy with your tumblr blogs privacy.
...
2. Another Screenshot of Tumblr Display
